 ...
 * [sdf.yml](sdf.yml)
     * Determines how your purl.obolibrary.org/obo/sdf/ redirects will be handled
     ...
     * Paste in the contents of [sdf.yml](sdf.yml)
 ...
 * [sdf.md](sdf.md)
     ...
     * Paste in the contents of [sdf.md](sdf.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
